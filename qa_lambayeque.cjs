...
(async () => {
  ...
  async function switchRegion(label) {
    const switcherBtn = await page.locator('button', { hasText: /Tumbes|Puno|Tacna|Piura|Ancash|Lambayeque/ }).first();
  ...
  const regions = ['Región Tumbes', 'Región Puno', 'Región Tacna', 'Región Piura', 'Región Ancash', 'Región Lambayeque'];

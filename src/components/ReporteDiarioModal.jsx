              ...
              <table className="w-full min-w-[900px] border-collapse text-left text-xs sm:text-sm">
                <thead className="sticky top-0 z-10 bg-surface-1">
                  <tr className="border-b border-white/10 text-[11px] font-semibold uppercase tracking-wide text-ink-mute">
                    ...
                    {mostrarEstado && <th className="px-2.5 py-2 sm:px-3 sm:py-3">Estado</th>}
                    <th className="px-2.5 py-2 sm:px-3 sm:py-3">Departamento</th>
                    <th className="px-2.5 py-2 sm:px-3 sm:py-3">Provincia / Distrito</th>
                    <th className="px-2.5 py-2 sm:px-3 sm:py-3">Tipo</th>
                    <th className="px-2.5 py-2 sm:px-3 sm:py-3">Descripción de la intervención</th>
                    {mostrarFicha && <th className="px-2.5 py-2 sm:px-3 sm:py-3">Ficha</th>}
                    <th className="px-2.5 py-2 sm:px-3 sm:py-3">Equipo / maquinaria desplegada</th>
                  </tr>
                </thead>
                <tbody>
                  {items.map((it) => (
                    <tr key={it.key} className="border-b border-white/[0.05] align-top odd:bg-white/[0.015]">
                      ...
                      <td className="max-w-[260px] px-2.5 py-2 sm:px-3 sm:py-3 text-xs text-ink-mute">

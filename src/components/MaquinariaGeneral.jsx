  ...
  return (
    <section id="maquinaria" className="relative border-t border-white/[0.05] bg-surface-1 py-24 sm:py-28">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeading
          eyebrow="Unidades Básicas Operativas · 8 regiones"
          title="Cantidad total de maquinarias"
          description="Flota vehicular y de maquinaria pesada asignada a las 8 UBOs regionales, sumada a nivel nacional."
        />
        ...
        <div className="mt-12 grid gap-4 lg:grid-cols-[320px_1fr]">
          <Reveal>
            <Card className="flex h-full flex-col items-center justify-center gap-2 p-8 text-center">
              ...
              <div className="text-xs text-ink-mute">Suma de las 8 regiones</div>
            </Card>
          </Reveal>

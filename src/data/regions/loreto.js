...
// Loreto NO hay Excel consolidado de fichas MVCS/ANA (el consolidado de 536 fichas solo
...
// corridas contra Producción -- ./_generated/loreto.js es el placeholder en cero (nunca
// inventado). Para llenarlo con datos reales, correr:
//   python pipeline/generar_todas_regiones.py --repo "D:\Presentacion_PNC" --regiones loreto --git-push
//
...
import datosBD from './_generated/loreto'
import galeria from '../galeria/loreto.json'
...
export default {
  ...
  // los datos viven en src/data/galeria/loreto.json, el panel los actualiza vía la API de GitHub.
  galeria,

...
// Cusco NO hay Excel consolidado de fichas MVCS/ANA (el consolidado de 536 fichas solo
...
// corridas contra Producción -- ./_generated/cusco.js es el placeholder en cero (nunca
// inventado). Para llenarlo con datos reales, correr:
//   python pipeline/generar_todas_regiones.py --repo "D:\Presentacion_PNC" --regiones cusco --git-push
//
...
import datosBD from './_generated/cusco'
import galeria from '../galeria/cusco.json'
...
export default {
  ...
  // los datos viven en src/data/galeria/cusco.json, el panel los actualiza vía la API de GitHub.
  galeria,

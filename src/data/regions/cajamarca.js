...
// Cajamarca NO hay Excel consolidado de fichas MVCS/ANA (el consolidado de 536 fichas solo
...
// corridas contra Producción -- ./_generated/cajamarca.js es el placeholder en cero (nunca
// inventado). Para llenarlo con datos reales, correr:
//   python pipeline/generar_todas_regiones.py --repo "D:\Presentacion_PNC" --regiones cajamarca --git-push
//
...
import datosBD from './_generated/cajamarca'
import galeria from '../galeria/cajamarca.json'

export default {
  id: 'cajamarca',
  label: 'Región Cajamarca',
  shortLabel: 'Cajamarca',

  meta: {
    region: 'Región Cajamarca',
  ...
  // los datos viven en src/data/galeria/cajamarca.json, el panel los actualiza vía la API de GitHub.
  galeria,

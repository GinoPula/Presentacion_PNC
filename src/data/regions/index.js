...
export const regions = { tumbes, puno, tacna, piura, ancash, lambayeque, ica, 'la-libertad': laLibertad, lima }

export const REGION_LIST = [tumbes, puno, tacna, piura, ancash, lambayeque, ica, laLibertad, lima].map((r) => ({ id: r.id, label: r.label, shortLabel: r.shortLabel }))

...
export default {
  ejecutadasPorTipo: [
    { tipo: 'Emergencia', cantidad: 19, m3: 177974.0, km: 12.29, poblacion: 269942, provincias: ['Chanchamayo', 'Chupaca', 'Huancayo', 'Satipo', 'Tarma'] },
  ...
  programadas: [
    ...
    { provincia: 'Chupaca', distrito: 'Chongos Bajo', cantidad: 2, metaVol: 17318.1, metaKm: 8.62, poblacion: 970 },
    ...
    { provincia: 'Huancayo', distrito: 'Chupuro', cantidad: 1, metaVol: 8694.0, metaKm: 5.02, poblacion: 360 },
    ...
    { provincia: 'Huancayo', distrito: 'Viques', cantidad: 1, metaVol: 9800.0, metaKm: 3.59, poblacion: 336 },
  ...
  programadasTotal: { cantidad: 18, metaVol: 150961.63, metaKm: 33.21, poblacion: 47676 },

  programadasDetalle: [
    { provincia: 'Jauja', distrito: 'Masma', sector: 'Zona Urbana', ficha: '007-2026-LD-P-JUN', descripcion: ' LIMPIEZA, DESCOLMATACION Y CONFORMACION DE DIQUES CON MATERIAL PROPIO DEL CAUCE DEL RIO MASMA, DE LA PROG 0+000 A LA PROG 1+500, EN VARIOS SECTORES DEL DISTRITO DE MASMA, PROVINCIA DE JAUJA, REGION JUNIN-00   ', fechaInicio: '05/05/2026', fechaFin: '18/05/2026', metaVol: 7000.0, metaKm: 1.5, poblacion: 600 },
    { provincia: 'Concepcion', distrito: 'Matahuasi', sector: 'Zona Urbana', ficha: '003-2026-LD-P-JUN', descripcion: ' "LIMPIEZA, DESCOLMATACION, ENCAUZAMIENTO Y CONFORMACIÓN DE DIQUE CON MATERIAL PROPIO DEL RIO SECO,  DE LA  PROG. 0+000 A LA PROG. 0+500, AMBAS MÁRGENES, EN LA ZONA URBANA DEL DISTRITO DE MATAHUASI, PROVINCIA DE CONCEPCIÓN, REGION JUNIN"-00                 ', fechaInicio: '01/08/2026', fechaFin: '14/08/2026', metaVol: 5714.0, metaKm: 1.0, poblacion: 300 },
    { provincia: 'Chanchamayo', distrito: 'Chanchamayo', sector: 'Zona Urbana', ficha: '002-2026-LD-P-JUN', descripcion: ' LIMPIEZA Y DESCOLMATACION DE LA QUEBRADA DEL RIO GAROU, DESDE LA PROG 0+000 A LA PROG 0+600, EN LA ZONA URBANA DEL DISTRITO DE CHANCHAMAYO, PROVINCIA DE CHANCHAMAYO, REGION JUNIN-00             ', fechaInicio: '15/08/2026', fechaFin: '28/08/2026', metaVol: 7500.0, metaKm: 0.6, poblacion: 3500 },
    { provincia: 'Huancayo', distrito: 'Chupuro', sector: 'Zona Urbana', ficha: '070-2026-LETV-E-JUN', descripcion: ' LIMPIEZA Y REMOCION DE ESCOMBROS A CONSECUENCIA DEL SISMO GRADO 5.1 DEL 18 DE JULIO DEL 2026 QUE\nINTERRUMPEN LA TRANSITABILIDAD EN EL DISTRITO DE CHUPURO, PROVINCIA DE HUANCAYO, REGION JUNI   ', fechaInicio: '22/08/2026', fechaFin: '22/09/2026', metaVol: 8694.0, metaKm: 5.02, poblacion: 360 },
    { provincia: 'Huancayo', distrito: 'Viques', sector: 'Zona Urbana', ficha: '069-2026-LETV-E-JUN', descripcion: 'LIMPIEZA Y REMOCION DE ESCOMBROS A CONSECUENCIA DEL SISMO GRADO 5.1 DEL 18 DE JULIO DEL 2026 QUE INTERRUMPEN LA TRANSITABILIDAD EN EL DISTRITO DE VIQUES, PROVINCIA DE HUANCAYO, REGION JUNIN    ', fechaInicio: '22/08/2026', fechaFin: '22/09/2026', metaVol: 9800.0, metaKm: 3.59, poblacion: 336 },
    { provincia: 'Chupaca', distrito: 'Chongos Bajo', sector: 'Zona Urbana', ficha: '072-2026-AA-U-JUN ', descripcion: ' ABASTECIMIENTO DE AGUA EN SITUACIONES DE EMERGENCIA A CONSECUENCIA DEL  SISMO GRADO 5.1 DEL 18 DE JULIO DEL 2026 EN EL C.P CHONGOS BAJO, DISTRITO DE CHONGOS BAJO, PROVINCIA DE CHUPACA, REGION JUNIN    ', fechaInicio: '24/08/2026', fechaFin: '07/09/2026', metaVol: 75.0, metaKm: 0.37, poblacion: 375 },
    { provincia: 'Chupaca', distrito: 'Chongos Bajo', sector: 'Zona Urbana', ficha: '071-2026-LETV-E-JUN ', descripcion: ' LIMPIEZA Y REMOCION DE ESCOMBROS PARA LA TRANSITABILIDAD DE VIAS EN C.P DE CHONGOS BAJO ETAPA 3 Y ALEDAÑOS, DISTRITO DE CHONGOS BAJO, PROVINCIA DE CHUPACA, REGION JUNIN ', fechaInicio: '24/08/2026', fechaFin: '22/09/2026', metaVol: 17243.1, metaKm: 8.25, poblacion: 595 },
    ...
    { provincia: 'Chanchamayo', distrito: 'Chanchamayo', sector: 'Zona Urbana', ficha: '010-2026-LD-P-JUN', descripcion: ' LIMPIEZA Y DESCOLMATACION EN RIO GAROU, EN LA PROGRESIVA 0+1.09 LM EN EL DISTRITO DE CHANCHAMAYO, PROVINCIA DE CHANCHAMAYO-REGION JUNIN-00  ', fechaInicio: '01/11/2026', fechaFin: '20/11/2026', metaVol: 1247.0, metaKm: 1.0, poblacion: 25200 },
  ...
  flota: [
    { tipo: 'Camión cisterna de agua', cantidad: 1, marca: 'ACS', codigos: ['R3-ACS'], estado: 'operativo' },
    { tipo: 'Camioneta', cantidad: 1, marca: 'Mitsubishi', codigos: ['EGO-049'], estado: 'inoperativo' },
    { tipo: 'Cargador frontal', cantidad: 2, marca: 'Caterpillar', codigos: ['JLX00221', 'JLX00220'], estado: 'operativo' },
    { tipo: 'Cargador frontal', cantidad: 1, marca: 'Caterpillar', codigos: ['M5K00335'], estado: 'inoperativo' },
    { tipo: 'Cargador frontal', cantidad: 2, marca: 'John Deere', codigos: ['D001609', 'D001612'], estado: 'operativo' },
    { tipo: 'Excavadora hidráulica', cantidad: 2, marca: 'Komatsu', codigos: ['85515', 'A10876'], estado: 'operativo' },
    ...
    { tipo: 'Retroexcavadora', cantidad: 1, marca: 'Caterpillar', codigos: ['CRS70638'], estado: 'operativo' },
    { tipo: 'Retroexcavadora', cantidad: 1, marca: 'John Deere', codigos: ['284924'], estado: 'operativo' },
    { tipo: 'Tractor sobre oruga', cantidad: 2, marca: 'Komatsu', codigos: ['81469', '81376'], estado: 'operativo' },
    { tipo: 'Volquete', cantidad: 1, marca: 'Hino', codigos: ['EGR-381'], estado: 'operativo' },
    { tipo: 'Volquete', cantidad: 3, marca: 'Mercedes Benz', codigos: ['EGV-760', 'EGV-812', 'EGV-796'], estado: 'operativo' },

...
export default {
  ...
  flota: [
    ...
    { tipo: 'Volquete', cantidad: 2, marca: 'Mercedes Benz', codigos: ['EGV-829', 'EGV-796'], estado: 'inoperativo' },
    { tipo: 'Volquete', cantidad: 2, marca: 'Mercedes Benz', codigos: ['EGV-760', 'EGV-812'], estado: 'operativo' },

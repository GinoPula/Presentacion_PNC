...
export default {
  ...
  programadasTotal: { cantidad: 15, metaVol: 131925.37, metaKm: 17.7, poblacion: 21390 },
  ...
  programadasDetalle: [
    ...
    { provincia: 'Concepcion', distrito: 'Matahuasi', sector: 'Zona Urbana', ficha: '003-2026-LD-P-JUN', descripcion: ' "LIMPIEZA, DESCOLMATACION, ENCAUZAMIENTO Y CONFORMACIÓN DE DIQUE CON MATERIAL PROPIO DEL RIO SECO,  DE LA  PROG. 0+000 A LA PROG. 0+500, AMBAS MÁRGENES, EN LA ZONA URBANA DEL DISTRITO DE MATAHUASI, PROVINCIA DE CONCEPCIÓN, REGION JUNIN"-00                   ', fechaInicio: '05/09/2026', fechaFin: '18/09/2026', metaVol: 5714.0, metaKm: 1.0, poblacion: 300 },
    ...
    { provincia: 'Tarma', distrito: 'Tarma', sector: 'Zona Urbana', ficha: '011-2026-LD-P-JUN', descripcion: ' "LIMPIEZA Y DESCOLMATACIÓN DEL CAUCE DEL RIO MANIACO AMBAS MÁRGENES, DE LA PROG. 0+000 A LA PROG. 1+820, EN LA ZONA URBANA DEL DISTRITO DE TARMA, PROVINCIA DE TARMA, REGIÓN JUNIN"-00                     ', fechaInicio: '18/09/2026', fechaFin: '04/10/2026', metaVol: 7414.4, metaKm: 1.8, poblacion: 3200 },
    { provincia: 'Chanchamayo', distrito: 'Chanchamayo', sector: 'Zona Urbana', ficha: '068-2026-LD-P-JUN', descripcion: 'LIMPIEZA, DESCOLMATACION Y ENCAUZAMIENTO DEL RIO GAROU, PROG. 0+000 A LA PROG. 1+897.11 KM TRAMO III DE LAZONA URBANA DE LA MERCED, DISTRITO Y PROVINCIA DE CHANCHAMAYO-REGION JUNIN', fechaInicio: '01/10/2026', fechaFin: '15/10/2026', metaVol: 6938.02, metaKm: 1.9, poblacion: 1920 },
    ...
    { provincia: 'Chanchamayo', distrito: 'Chanchamayo', sector: 'Rio Toro', ficha: '001-2026-LD-P-JUN', descripcion: 'LIMPIEZA, DESCOLMATACION ENCAUZAMIENTO Y CONFORMACION DE DIQUES CON MATERIAL PROPIO, DEL RIO TORODESDE LA PROGRESIVA 0+000 AL 0+681.98 EN LA ZONA URBANA DE LA MERCED, DISTRITO Y PROVINCIA DE\nCHANCHAMAYO, REGION JUNIN', fechaInicio: '12/10/2026', fechaFin: '26/10/2026', metaVol: 16000.0, metaKm: 0.3, poblacion: 3500 },
    ...
    { provincia: 'Jauja', distrito: 'Masma', sector: 'Zona Urbana', ficha: '006-2026-LD-P-JUN', descripcion: ' "LIMPIEZA, DESCOLMATACION Y CONFORMACIÓN DE DIQUE CON MATERIAL PROPIO DEL CAUCE DEL RIO MASMA  DE LA  PROG. 0+000 A LA PROG. 1+500, VARIOS SECTORES AMBAS MARGENES, EN LA ZONA URBANA DEL DISTRITO DE MASMA, PROVINCIA DE JAUJA, REGION JUNIN"-00                    ', fechaInicio: '01/12/2026', fechaFin: '15/12/2026', metaVol: 7000.0, metaKm: 1.5, poblacion: 600 },
    { provincia: 'Huancayo', distrito: 'Pucara', sector: 'Zona Urbana', ficha: '005-2026-LD-P-JUN', descripcion: 'LIMPIEZA, DESCOLMATACION Y CONFORMACION DE DIQUES CON MATERIAL PROPIO DEL CAUCE DEL RIO CHANCHAS VARIOS TRAMOS DE LA PROG. 0+000 A LA PROG. 3+158 AMBAS MARGENES, EN LA ZONA URBANA DEL DISTRITO DE PUCARA, PROVINCIA HUANCAYO, REGION JUNIN-00         ', fechaInicio: '12/12/2026', fechaFin: '26/12/2026', metaVol: 16702.3, metaKm: 3.16, poblacion: 770 },
  ],
  ...
  flota: [
    ...
    { tipo: 'Retroexcavadora', cantidad: 1, marca: 'John Deere', codigos: ['284924'], estado: 'inoperativo' },
    { tipo: 'Retroexcavadora', cantidad: 1, marca: 'New Holland', codigos: ['NNHH09046'], estado: 'operativo' },
    ...
    { tipo: 'Volquete', cantidad: 3, marca: 'Mercedes Benz', codigos: ['EGV-796', 'EGV-760', 'EGV-812'], estado: 'operativo' },

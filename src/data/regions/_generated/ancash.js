...
export default {
  ...
  enEjecucion: [
    { provincia: 'Huaraz', distrito: 'Huaraz', tipo: 'Prevención', descripcion: 'LIMPIEZA, DESCOLMATACIÓN Y CONFORMACIÓN DE TALUD EN AMBAS MARGENES DEL RÍO SANTA, SECTOR SAN PEDRO, DISTRITO DE HUARAZ, PROVINCIA HUARAZ, REGIÓN ANCASH', inicio: '21/08/2026', fin: '03/09/2026', volAcum: 2760, poblacion: 154 },
    { provincia: 'Yungay', distrito: 'Shupluy', tipo: 'Prevención', descripcion: 'LIMPIEZA Y DESCOLMATACIÓN DE LA QUEBRADA SANTO TORIBIO TRAMO I, DISTRITO DE SHUPLUY, PROVINCIA DE YUNGAY, REGION ANCASH', inicio: '13/08/2026', fin: '24/08/2026', volAcum: 3676, poblacion: 2516 },
  ],
  ...
  programadasTotal: { cantidad: 21, metaVol: 126040.85, metaKm: 11.11, poblacion: 12061 },
  ...
  flota: [
    ...
    { tipo: 'Excavadora hidráulica', cantidad: 1, marca: 'Komatsu', codigos: ['85461'], estado: 'inoperativo', nota: 'Fuga de aceite hidráulico.' },
    { tipo: 'Excavadora hidráulica', cantidad: 1, marca: 'Komatsu', codigos: ['A10879'], estado: 'inoperativo', nota: 'HT 21014-2026: requerimiento de servicio para reparación de motor.' },

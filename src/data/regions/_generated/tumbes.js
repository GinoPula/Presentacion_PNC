...
export default {
  ...
  ejecutadasPorTipoAnioAnterior: [
    ...
    { tipo: 'Prevención', cantidad: 49, m3: 158711.48, km: 33.94, poblacion: 69230, provincias: ['Contralmirante Villar', 'Tumbes', 'Zarumilla'] },
    { tipo: 'Urgente atención', cantidad: 21, m3: 12889.0, km: 2.68, poblacion: 19109, provincias: ['Tumbes'] },
  ],
  ejecutadasTotalAnioAnterior: { cantidad: 75, m3: 194187.73, m3AguaPotable: 7875.0, km: 43.19, poblacion: 92958 },
  ...
  programadasDetalle: [
    { provincia: 'Tumbes', distrito: 'Corrales', sector: 'Malval', ficha: '073-2026-LD-E-TUM', descripcion: 'LIMPIEZA Y DESCOLMATACIÓN DEL CAUCE DE LA QUEBRADA BOLIVAR, EN EL SECTOR MALVAL DEL DISTRITO DE CORRALES, PROVINCIA DE TUMBES, DEPARTAMENTO DE TUMBES\tDS180\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  ', fechaInicio: '25/09/2026', fechaFin: '09/10/2026', metaVol: 3375.0, metaKm: 0.45, poblacion: 527 },
    ...
    { provincia: 'Tumbes', distrito: 'San Jacinto', sector: 'Vista Hermosa', ficha: '074-2026-LD-E-TUM', descripcion: 'LIMPIEZA Y DESCOLMATACIÓN DEL CAUCE DE LA QUEBRADA RICA PLAYA, EN EL SECTOR VISTA HERMOSA DEL DISTRITO DE SAN JACINTO, PROVINCIA DE TUMBES, DEPARTAMENTO DE TUMBES  DS180', fechaInicio: '10/10/2026', fechaFin: '24/10/2026', metaVol: 4200.0, metaKm: 0.3, poblacion: 269 },

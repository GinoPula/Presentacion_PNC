...
// Amazonas NO hay Excel consolidado de fichas MVCS/ANA (el consolidado de 536 fichas solo
...
// corridas contra Producción -- ./_generated/amazonas.js es el placeholder en cero (nunca
...
import datosBD from './_generated/amazonas'
import galeria from '../galeria/amazonas.json'

export default {
  id: 'amazonas',
  label: 'Región Amazonas',
  shortLabel: 'Amazonas',

  meta: {
    region: 'Región Amazonas',
  ...
  // los datos viven en src/data/galeria/amazonas.json, el panel los actualiza vía la API de GitHub.
  galeria,

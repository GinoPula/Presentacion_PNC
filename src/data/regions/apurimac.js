...
// Apurímac NO hay Excel consolidado de fichas MVCS/ANA (el consolidado de 536 fichas solo
...
// corridas contra Producción -- ./_generated/apurimac.js es el placeholder en cero (nunca
// inventado). Para llenarlo con datos reales, correr:
//   python pipeline/generar_todas_regiones.py --repo "D:\Presentacion_PNC" --regiones apurimac --git-push
//
...
import datosBD from './_generated/apurimac'
import galeria from '../galeria/apurimac.json'

export default {
  id: 'apurimac',
  label: 'Región Apurímac',
  shortLabel: 'Apurímac',

  meta: {
    region: 'Región Apurímac',
  ...
  // los datos viven en src/data/galeria/apurimac.json, el panel los actualiza vía la API de GitHub.
  galeria,

...
// Ucayali NO hay Excel consolidado de fichas MVCS/ANA (el consolidado de 536 fichas solo
...
// corridas contra Producción -- ./_generated/ucayali.js es el placeholder en cero (nunca
// inventado). Para llenarlo con datos reales, correr:
//   python pipeline/generar_todas_regiones.py --repo "D:\Presentacion_PNC" --regiones ucayali --git-push
//
...
import datosBD from './_generated/ucayali'
import galeria from '../galeria/ucayali.json'

export default {
  id: 'ucayali',
  label: 'Región Ucayali',
  shortLabel: 'Ucayali',

  meta: {
    region: 'Región Ucayali',
  ...
  // los datos viven en src/data/galeria/ucayali.json, el panel los actualiza vía la API de GitHub.
  galeria,

...
// Callao NO hay Excel consolidado de fichas MVCS/ANA (el consolidado de 536 fichas solo
...
// corridas contra Producción -- ./_generated/callao.js es el placeholder en cero (nunca
...
import datosBD from './_generated/callao'
import galeria from '../galeria/callao.json'
...
export default {
  ...
  // los datos viven en src/data/galeria/callao.json, el panel los actualiza vía la API de GitHub.
  galeria,

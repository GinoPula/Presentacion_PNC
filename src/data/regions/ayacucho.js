...
// Ayacucho NO hay Excel consolidado de fichas MVCS/ANA (el consolidado de 536 fichas solo
...
// corridas contra Producción -- ./_generated/ayacucho.js es el placeholder en cero (nunca
// inventado). Para llenarlo con datos reales, correr:
//   python pipeline/generar_todas_regiones.py --repo "D:\Presentacion_PNC" --regiones ayacucho --git-push
//
...
import datosBD from './_generated/ayacucho'
import galeria from '../galeria/ayacucho.json'

export default {
  id: 'ayacucho',
  label: 'Región Ayacucho',
  shortLabel: 'Ayacucho',

  meta: {
    region: 'Región Ayacucho',
  ...
  // los datos viven en src/data/galeria/ayacucho.json, el panel los actualiza vía la API de GitHub.
  galeria,

...
// Huánuco NO hay Excel consolidado de fichas MVCS/ANA (el consolidado de 536 fichas solo
...
// corridas contra Producción -- ./_generated/huanuco.js es el placeholder en cero (nunca
// inventado). Para llenarlo con datos reales, correr:
//   python pipeline/generar_todas_regiones.py --repo "D:\Presentacion_PNC" --regiones huanuco --git-push
//
...
import datosBD from './_generated/huanuco'
import galeria from '../galeria/huanuco.json'

export default {
  id: 'huanuco',
  label: 'Región Huánuco',
  shortLabel: 'Huánuco',
  ...
  // los datos viven en src/data/galeria/huanuco.json, el panel los actualiza vía la API de GitHub.
  galeria,

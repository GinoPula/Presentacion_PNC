// Datos de la región Huancavelica.
...
// Huancavelica NO hay Excel consolidado de fichas MVCS/ANA (el consolidado de 536 fichas solo
...
// corridas contra Producción -- ./_generated/huancavelica.js es el placeholder en cero (nunca
...
import datosBD from './_generated/huancavelica'
import galeria from '../galeria/huancavelica.json'

export default {
  id: 'huancavelica',
  label: 'Región Huancavelica',
  shortLabel: 'Huancavelica',
  ...
  // los datos viven en src/data/galeria/huancavelica.json, el panel los actualiza vía la API de GitHub.
  galeria,

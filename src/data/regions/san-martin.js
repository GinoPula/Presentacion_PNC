...
// San Martín NO hay Excel consolidado de fichas MVCS/ANA (el consolidado de 536 fichas solo
...
// corridas contra Producción -- ./_generated/san-martin.js es el placeholder en cero (nunca
// inventado). Para llenarlo con datos reales, correr:
//   python pipeline/generar_todas_regiones.py --repo "D:\Presentacion_PNC" --regiones san-martin --git-push
//
...
import datosBD from './_generated/san-martin'
import galeria from '../galeria/san-martin.json'

export default {
  id: 'san-martin',
  label: 'Región San Martín',
  shortLabel: 'San Martín',

  meta: {
    region: 'Región San Martín',
  ...
  // los datos viven en src/data/galeria/san-martin.json, el panel los actualiza vía la API de GitHub.
  galeria,

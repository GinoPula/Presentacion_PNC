...
export default {
  ejecutadasPorTipo: [
    { tipo: 'Emergencia', cantidad: 15, m3: 78115.33, km: 23.41, poblacion: 26096 },
  ...
  ejecutadasTotal: { cantidad: 50, m3: 265134.51, km: 100.93, poblacion: 149411 },

  enEjecucion: [
    { provincia: 'Huancabamba', distrito: 'Canchaque', tipo: 'Emergencia', descripcion: 'LEVANTAMIENTO DE ESCOMBROS QUE INTERRUMPEN LA TRANSITABILIDAD DEL CAMINO VECINAL ENTRE LOS TRAMOS DE PAPAYAL BAJO, MONTE GRANDE, PIEDRA BLANCA, PAPAYAL ALTO, HUAMALA ALTO, HUAMALA BAJO Y SOCCHA ALTA, DISTRITO DE CANCHAQUE - PROVINCIA DE HUANCABAMBA - DEPARTAMENTO DE PIURA', inicio: '19/08/2026', fin: '07/09/2026', volAcum: 2000, poblacion: 372 },
    { provincia: 'Huancabamba', distrito: 'Sondorillo', tipo: 'Emergencia', descripcion: 'LIMPIEZA, DESCOLMATACION Y CONFORMACION DE DIQUE EN LA QUEBRADA LOS MOROS, SECTOR LAS JUNTAS EN LA LOCALIDAD DE SONDORILLO, DISTRITO DE SONDORILLO', inicio: '21/07/2026', fin: '24/08/2026', volAcum: 18600, poblacion: 1200 },
    { provincia: 'Morropon', distrito: 'Chulucanas', tipo: 'Emergencia', descripcion: 'LIMPIEZA, DESCOLMATACION Y CONFORMACION DE DIQUE, DE LA QUEBRADA LA PEÑA - TRAMO II, CASERIO DE LA PEÑA, DISTRITO DE CHULUCANAS, PROVINCIA DE MORROPÓN, DEPARTAMENTO PIURA', inicio: '06/08/2026', fin: '25/08/2026', volAcum: 3400, poblacion: 110 },
  ],
  ...
  programadas: [
    ...
    { provincia: 'Piura', distrito: 'Veintiseis De Octubre', cantidad: 5, metaVol: 51302.21, metaKm: 7.58, poblacion: 28849 },
  ],
  programadasTotal: { cantidad: 46, metaVol: 275556.73, metaKm: 41.52, poblacion: 157305 },
  ...
  flota: [
    { tipo: 'Retroexcavadora', cantidad: 2, marca: 'John Deere', codigos: ['285270', 'C429243'], estado: 'operativo' },
    { tipo: 'Excavadora hidráulica', cantidad: 3, marca: 'John Deere', codigos: ['810139', '810396', 'D810495'], estado: 'operativo' },
    ...
    { tipo: 'Tractor sobre oruga', cantidad: 1, marca: 'Caterpillar', codigos: ['AE800572'], estado: 'operativo' },
    { tipo: 'Cargador frontal', cantidad: 3, marca: 'John Deere', codigos: ['D001578', 'D001580', 'D001587'], estado: 'operativo' },
    { tipo: 'Mini cargador', cantidad: 1, marca: 'John Deere', codigos: ['G278937'], estado: 'operativo' },
    { tipo: 'Mini cargador', cantidad: 2, marca: 'John Deere', codigos: ['G261847', 'G278945'], estado: 'inoperativo', nota: 'Mantenimiento correctivo del sistema hidráulico por fugas de aceite. HT N° 116244 / HT N° 116251' },
    { tipo: 'Tractor sobre oruga', cantidad: 1, marca: 'Caterpillar', codigos: ['J8B05113'], estado: 'operativo' },
    ...
    { tipo: 'Excavadora hidráulica', cantidad: 2, marca: 'Caterpillar', codigos: ['TJT10095', 'TJT10107'], estado: 'operativo' },
    { tipo: 'Remolcador', cantidad: 1, marca: 'Volvo', codigos: ['EAJ-376'], estado: 'operativo' },
    { tipo: 'Volquete', cantidad: 3, marca: 'Mercedes Benz', codigos: ['EAJ-390', 'EAJ-400', 'EAJ-455'], estado: 'operativo' },
    ...
    { tipo: 'Camioneta', cantidad: 2, marca: 'Mitsubishi', codigos: ['EGM-051', 'EGO-003'], estado: 'operativo' },
    { tipo: 'Camión cisterna de combustible', cantidad: 1, marca: 'Mercedes Benz', codigos: ['EGM-975'], estado: 'operativo' },
    { tipo: 'Camión cisterna de agua', cantidad: 5, marca: 'Mercedes Benz', codigos: ['EGM-995', 'EGN-003', 'EGN-011', 'EGN-012', 'EGN-029'], estado: 'operativo' },
    ...
    { tipo: 'Volquete', cantidad: 6, marca: 'Mercedes Benz', codigos: ['EGV-769', 'EGV-770', 'EGV-783', 'EGV-807', 'EGV-809', 'EGV-822'], estado: 'operativo' },
